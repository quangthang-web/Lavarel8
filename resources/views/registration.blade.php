        ...
        <div class="mt-5">
            <form action="postregistration" method="post">
                ...
                <div class="w-25 m-0 m-auto">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput2" class="form-label">Nhập lại Mật Khẩu</label>
                        <input type="password" class="form-control" id="exampleFormControlInput2" name="restartpassword"
                            placeholder="Nhập Mật Khẩu">
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary">Đăng Nhập</button>
                    </div>
                    <a href="/">Quay lại đang nhập</a>
                </div>
            </form>
        </div>
    </div>
